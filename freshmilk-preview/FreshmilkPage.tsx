...
function FarmStory() {
  return (
    <section className="mx-auto flex max-w-[1440px] justify-center px-5 py-5 lg:h-[448px] lg:px-20">
      <div className="relative grid w-full max-w-[1280px] grid-cols-1 items-center gap-8 overflow-hidden rounded-[24px] bg-white px-6 py-8 md:grid-cols-2 lg:h-[408px] lg:grid-cols-[588px_588px] lg:gap-10 lg:py-6 lg:pl-10 lg:pr-6">
        ...
        <div className="relative z-10 max-w-[560px] pt-0 lg:pt-5">
          <div className="inline-flex items-center rounded-full border border-[#b2ddff] bg-[#eff8ff] p-1 pr-[10px] text-[12px] font-medium leading-[18px] text-[#175cd3]">
            <span className="rounded-full border border-[#b2ddff] bg-white px-2 py-0.5">FRESHMILK</span>
            <span className="ml-2">Our Farm</span>
          </div>
          <h2 className="mt-5 text-[30px] font-semibold leading-[38px] text-[#101828]">Our Farm Story</h2>
          <p className="mt-4 text-[18px] leading-7 text-[#475467]">
        ...
        <video
          className="relative z-10 h-[280px] w-full overflow-clip rounded-[16px] object-cover object-center md:h-[360px] lg:w-[588px]"
          autoPlay
          loop
          muted
          playsInline
  ...
  return (
    <div className="w-[120px]">
      ...
      <div className="mt-4 flex flex-col gap-3 text-[16px] font-semibold leading-6 text-[#475467]">
        {links.map((link) => (
          <button key={link} className={`w-fit text-left hover:translate-x-1 hover:text-[#155eef] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#155eef] ${buttonMotion}`}>
            {link}
          </button>
        ))}
      </div>
    ...
    <footer className="bg-white px-5 pt-16 pb-8 lg:px-20">
      <div className="mx-auto flex max-w-[1280px] flex-col justify-between gap-12 lg:h-[240px] lg:flex-row">
        ...
        <div className="flex flex-wrap gap-10 lg:min-w-[640px] lg:justify-end">
          <FooterColumn title="Main Pages" links={["Home", "Order", "Our Farm", "Tutorials", "Pricing", "Releases"]} />
