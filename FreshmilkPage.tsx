...
function Logo() {
  return (
    <div className="font-serif text-[28px] font-semibold leading-[24px] tracking-[-0.04em] text-[#010a1e] lg:text-[40px] lg:leading-[30px]">
    ...
    <article
      className={
        hero
          ...
          : `group min-h-[294px] overflow-hidden rounded-[18px] bg-white shadow-sm hover:-translate-y-0.5 hover:shadow-xl sm:min-h-[318px] lg:h-[334px] lg:rounded-[20px] ${cardMotion}`
      }
    >
      <div className={hero ? "p-3 pb-0" : "p-2 pb-0"}>
        <div className={hero ? "grid h-[200px] place-items-center overflow-hidden rounded-[20px]" : "grid h-[158px] place-items-center rounded-[14px] bg-[#f8fafc] sm:h-[178px] lg:h-[200px] lg:rounded-[16px]"}>
          <img
            src={image}
            alt=""
      ...
      <div className={hero ? "px-4 pb-4 pt-3" : "px-3 py-3 lg:px-4"}>
        <h3 className={hero ? "text-[20px] font-semibold leading-7 text-[#0f172a]" : "min-h-10 text-[13px] font-semibold leading-5 text-[#101828] sm:text-[14px]"}>{title}</h3>
...
function Section({ title, children }: { title: string; children: ReactNode }) {
  return (
    <section className="mx-auto w-full max-w-[1440px] px-4 pt-2 pb-5 sm:px-5 lg:px-20">
      <div className="mb-3 flex min-h-10 items-center justify-between gap-4">
        <h2 className="text-[24px] font-semibold leading-8 tracking-[-0.02em] text-[#101828] sm:text-[28px] sm:leading-9 lg:text-[32px] lg:leading-10">{title}</h2>
...
function CategoryCard({ image, label }: { image: string; label: string }) {
  ...
  return (
    <article className={`group h-[184px] rounded-[16px] p-3 text-center shadow-sm hover:-translate-y-0.5 hover:shadow-xl sm:h-[216px] sm:p-4 lg:h-[236px] ${cardMotion} ${gradientMap[label] ?? "bg-gradient-to-b from-[#93C5FD] to-[#EFF6FF]"}`}>
      <div className="grid h-[112px] place-items-center rounded-[16px] bg-transparent sm:h-[136px] lg:h-[150px]">
        <img src={image} alt="" className={`max-h-[102px] object-contain group-hover:scale-[1.03] sm:max-h-[122px] lg:max-h-[132px] ${cardInnerMotion}`} />
      </div>
      <h3 className={`mt-3 text-[13px] font-semibold leading-5 text-[#101828] group-hover:text-[#155eef] sm:mt-4 sm:text-[14px] ${cardInnerMotion}`}>{label}</h3>
    </article>
  );
}
...
function Cta({ variant = "green" }: { variant?: "green" | "cream" }) {
  ...
  return (
    <section ref={ctaRef} className="bg-[#f1f5f9] px-4 py-5 sm:px-5 lg:px-20">
      <div
        className={[
          "relative mx-auto flex min-h-[360px] max-w-[1280px] items-center overflow-hidden rounded-[24px] px-5 py-10 sm:min-h-[400px] sm:px-6 sm:py-16 lg:min-h-[440px] lg:rounded-[32px] lg:px-16",
        ...
        <div className="relative z-10 w-full max-w-[680px]">
          {!cream && (
            <div
              ...
              className="mb-4 flex flex-col items-start gap-2 text-[13px] leading-5 text-[#475569] sm:flex-row sm:items-center sm:gap-3 sm:text-[14px]"
            ...
            >
              ...
              <span className="max-w-[230px] sm:max-w-[190px]">
          ...
          <h2
            ...
            className="text-[30px] font-semibold leading-[1.14] tracking-[-0.02em] text-[#101828] sm:text-[42px] lg:text-[48px] lg:leading-[60px]"
          ...
          <p
            ...
            className="mt-4 max-w-[620px] text-[16px] leading-6 text-[#475467] sm:text-[18px] sm:leading-7 lg:text-[20px] lg:leading-[30px]"
...
function FeatureCards() {
  ...
  return (
    <section className="mx-auto grid max-w-[1440px] grid-cols-1 gap-4 px-4 py-5 sm:px-5 md:grid-cols-3 lg:px-20">
      {cards.map(([kicker, title, color, hoverText], index) => (
        <article key={title} className={`group relative h-[360px] overflow-hidden rounded-[20px] ${color} p-6 text-white hover:-translate-y-0.5 hover:shadow-2xl sm:h-[420px] sm:p-8 md:h-[474px] lg:rounded-[24px] ${featureMotion}`}>
          <p className="text-[16px] font-semibold leading-6">{kicker}</p>
          <h3 className="mt-2 max-w-[280px] text-[26px] font-semibold leading-8 tracking-[-0.02em] sm:text-[32px] sm:leading-10">{title}</h3>
          <img
            src={assets.feature[index]}
            alt=""
            className={`absolute bottom-0 left-1/2 h-[218px] -translate-x-1/2 object-contain sm:h-[250px] md:h-[280px] ${featureInnerMotion} group-hover:bottom-12 group-hover:h-[190px] group-hover:scale-[1.01] sm:group-hover:h-[220px] md:group-hover:h-[230px]`}
          />
          <div
...
function FarmStory() {
  ...
  return (
    <section ref={farmRef} className="mx-auto flex max-w-[1440px] justify-center px-4 py-5 sm:px-5 lg:h-[448px] lg:px-20">
      <div className="relative grid w-full max-w-[1280px] grid-cols-1 items-center gap-6 overflow-hidden rounded-[24px] bg-white px-5 py-7 sm:gap-8 sm:px-6 sm:py-8 md:grid-cols-2 lg:h-[408px] lg:grid-cols-[minmax(0,1fr)_minmax(0,588px)] lg:gap-10 lg:py-6 lg:pl-10 lg:pr-6">
        ...
        <div className="relative z-10 max-w-[560px] pt-0 lg:pt-5">
          ...
          <h2
            ...
            className="mt-5 text-[26px] font-semibold leading-8 text-[#101828] sm:text-[30px] sm:leading-[38px]"
          ...
          <p
            ...
            className="mt-4 text-[16px] leading-6 text-[#475467] sm:text-[18px] sm:leading-7"
        ...
        <video
          className="relative z-10 h-[220px] w-full max-w-[564px] overflow-clip rounded-[16px] object-cover object-center sm:h-[280px] md:h-[360px] lg:justify-self-end"
          autoPlay
          loop
          muted
          playsInline
  ...
  return (
    <main className="min-h-screen bg-[#f1f5f9] font-['Inter',sans-serif] text-[#101828]">
      ...
      <header className="bg-white/95 backdrop-blur-xl">
        <div className="mx-auto flex h-16 max-w-[1280px] items-center justify-between gap-2 px-4 sm:h-20 sm:px-5 lg:px-0">
          <div className="flex min-w-0 flex-1 items-center gap-3">
            <button className={`flex h-9 items-center gap-1.5 rounded-full border border-[#d0d5dd] bg-white px-2 text-[13px] font-semibold leading-5 text-[#344054] hover:border-[#b2ddff] hover:text-[#155eef] sm:h-10 sm:gap-2 sm:px-[10px] sm:text-[14px] ${pillShadow} ${buttonMotion}`}>
              <USFlagIcon />
              <span>EN</span>
          ...
          <div className="flex min-w-0 flex-1 items-center justify-end gap-3">
            ...
            <button className={`flex h-10 shrink-0 items-center gap-1 rounded-full bg-[#0f172a] px-3 text-[14px] font-semibold leading-5 text-white hover:-translate-y-0.5 hover:bg-[#155eef] hover:shadow-lg sm:h-11 sm:px-4 ${pillShadow} ${buttonMotion}`}>
              <UserIcon />
      ...
      <nav>
        <div className="mx-auto flex h-[64px] max-w-[1280px] items-start justify-start gap-3 overflow-x-auto px-4 pt-3 [scrollbar-width:none] sm:h-[76px] sm:px-5 sm:pt-5 lg:justify-between lg:px-0 [&::-webkit-scrollbar]:hidden">
          <div className="flex h-12 min-w-max shrink-0 items-center gap-4 rounded-full bg-white px-4 py-3 sm:h-14 sm:gap-8 sm:px-6 sm:py-4">
          ...
          <div className="flex h-12 shrink-0 items-center gap-4 rounded-full bg-white px-4 py-3 sm:h-14 sm:gap-8 sm:px-6 sm:py-4">
      ...
      <section ref={heroRef} className="px-4 py-4 sm:px-5 sm:py-5 lg:px-20">
        <div className="relative mx-auto h-[590px] max-w-[1280px] overflow-hidden rounded-[24px] bg-gradient-to-b from-[#3b82f6] to-[#1e40af] sm:h-[680px] lg:h-[700px] lg:rounded-[32px]">
          <img src={assets.heroBg} alt="" className="absolute left-[-170px] top-[-74px] h-[680px] w-[1160px] max-w-none object-cover opacity-20 blur-[2px] sm:left-[-120px] sm:h-[760px] lg:left-[-59px] lg:h-[783px] lg:w-[1398px]" />
          <h1
            key={`hero-title-${heroCycle}`}
            className="absolute left-1/2 top-4 z-10 -translate-x-1/2 bg-gradient-to-b from-white from-[26%] to-white/40 bg-clip-text text-center font-serif text-[50px] leading-[1.05] tracking-normal text-transparent min-[390px]:text-[54px] sm:top-0 sm:text-[118px] md:text-[152px] lg:text-[200px] lg:leading-[257px]"
            style={{ animation: "hero-title-rise 2400ms cubic-bezier(0.16,1,0.3,1) 260ms both" }}
          >
            FRESHMILK
          </h1>
          <img src={assets.woman} alt="" className="absolute left-1/2 top-[84px] z-10 h-[360px] w-[360px] -translate-x-1/2 object-contain min-[390px]:h-[390px] min-[390px]:w-[390px] sm:top-[86px] sm:h-[540px] sm:w-[540px] lg:top-[60px] lg:h-[640px] lg:w-[640px]" />
          <div className="absolute inset-x-4 bottom-5 z-20 max-w-[400px] sm:left-5 sm:right-auto">
            <span
              key={`hero-badge-${heroCycle}`}
              className="inline-flex items-center rounded-full bg-[#fde047] px-3 py-0.5 text-[13px] font-medium leading-5 text-[#172554] sm:px-4 sm:text-[14px]"
            ...
            <h2
              ...
              className="mt-4 max-w-[350px] text-[27px] font-semibold leading-[34px] text-white sm:mt-5 sm:max-w-[375px] sm:text-[36px] sm:leading-[44px]"
            ...
            <p
              ...
              className="mt-[10px] max-w-[340px] text-[14px] font-medium leading-5 text-[#dbeafe] sm:max-w-[400px] sm:text-[16px] sm:leading-6 sm:text-[#cbd5e1]"
            ...
            <button
              ...
              className={`mt-5 flex h-[52px] items-center gap-3 rounded-full bg-[#0f172a] pl-5 pr-3 text-[15px] font-semibold leading-6 text-white shadow-sm hover:-translate-y-0.5 hover:bg-[#155eef] hover:shadow-xl sm:mt-6 sm:h-[60px] sm:pl-6 sm:pr-4 sm:text-[16px] ${buttonMotion}`}
